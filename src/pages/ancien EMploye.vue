    ...
    <div class="container-fluid">
      <div class="row">
        <main :class="$style.table" :scrollable="true">
          ...
          <div :class="['row', $style.rowStyle]" :scrollable="true">
            <div v-for="member in filteredMembers" :key="member._id" :class="[
              getClassForDepartment(member.departmentId._id),
              !member._match && searchQuery ? $style.fadeOut : ''
            ]">
              ...
              <div :class="$style.employeeTextData">
                ...
                <span :class="$style.employeeJob">Id checkin : 4</span>
          ...
          <section>
                ...
                <form>
                  <div class="user-details">
                    ...
                    <div class="input-box">
                      ...
                      <input type="text" placeholder="Selectioner le post" required
                        v-model="clickMember.deviceUserId" />
                    </div>
            ...
            <!--  -->
            <modal name="ajouterEmployée" height="auto" :scrollable="true" :shiftX="0.4" :shiftY="0.5" @closed="resetForm">
              <div class="container">
                ...
                <form @submit.prevent="handleSubmit">
                  <div class="user-details">
                    ...
                    <div class="input-box">
                      <span class="details">Id Zkteco</span>
                      <input type="text" placeholder="Selectioner le post" required
                        v-model="employeeDetails.deviceUserId" />
                    </div>
...
export default {
  ...
  mounted() {
   ...
   computed: {
    filteredMembers() {
      if (!this.searchQuery) {
        return this.members.map(m => ({ ...m, _match: true }));
      }
