      ...
      <div class="row">
        <main :class="$style.table">
          ...
          <section>
            ...
            <modal name="modifierUtilisateur" height="auto" :scrollable="true" :shiftX="0.4" :shiftY="0.5">
              <div class="container">
                <div class="title">Modification de attendance</div>
                <form action="#">
                  <div class="user-details">
                    <div class="input-box">
                      <span class="details">Model</span>
                      <input type="text" placeholder="Entrer le model" required v-model="clickMember.model" />
                    </div>
                    <div class="input-box">
                      <span class="details">Marque</span>
                      <input type="text" placeholder="Entrer la marque" required v-model="clickMember.marque" />
                    </div>
                    <div class="input-box">
                      <span class="details">Type</span>
                      <input type="text" placeholder="Entrer le type" required v-model="clickMember.type" />
                    </div>
                    <div class="input-box">
                      <span class="details">À propos</span>
                      <input type="text" placeholder="À propos de la attendance" required v-model="clickMember.about" />
                    </div>
                    <div class="input-box">
                      <span class="details">Prix</span>
                      <input type="number" placeholder="Entrer le prix" required v-model="clickMember.prix" />
                    </div>
                    <div class="input-box">
                    ...
                    <div class="input-box">
                      ...
                      <input type="text" placeholder="Consommation" required v-model="clickMember.consommation" />
                    </div>
                    <div class="input-box">
                      <span class="details">Couleur</span>
                      <input type="text" placeholder="Couleur" required v-model="clickMember.couleur" />
                    </div>
                    <div class="input-box">
                      <span class="details">Boîte de Vitesse</span>
                      <input type="text" placeholder="Boîte de vitesse" required v-model="clickMember.boiteDeVitesse" />
                    </div>
                    <div class="input-box">
                      <span class="details">Status</span>
                      <input type="text" placeholder="Status" required v-model="clickMember.status" />
                    </div>
                    <div class="input-box">
                      <span class="details">Note</span>
                      <input type="number" placeholder="Note" required v-model="clickMember.note" />
                    </div>
                    <!-- <div class="input-box">
            ...
            <modal name="supprimerUtilisateur" height="auto" :scrollable="true" :shiftX="0.4" :shiftY="0.5">
              <div class="container">
                <div class="title">Suprresion de attendance</div>
                <form action="#">
                  <div class="user-details">
                    <div class="input-box">
      ...
      axios
        ...
        .then((response) => {
          if (response.data.error) {
            ...
            this.filteredMembers = this.members.slice(0, 30);
