      ...
      <div class="row">
        <main :class="$style.table">
          <section :class="$style.table__header">
            <h2 style="">Liste des réservations</h2>
            ...
            <table :class="$style['mainTable']">
              <thead :class="$style['tableauThead']">
                <tr :class="$style['tableauTrHeader']">
                  ...
                  <th data-role="sort-header">Nom d'utilisateur</th>
                  <!--  -->
                ...
                <form action="#">
                  <div class="user-details">
                    ...
                    <div class="input-box">
                      ...
                      <input
                        type="text"
                        placeholder="Entrer le jour de d'arrive"
                        required
...
export default {
  ...
  methods: {
    ...
    getAllMembers() {
      axios
        .get("https://gestionlocationvoiture.onrender.com/api/v1/Reservation")
        .then((response) => {
    ...
    //   axios
    //     .post(
    //       "https://gestionlocationvoiture.onrender.com/api/v1/Reservation/",
    //       {
    ...
    EditMember() {
      axios
        .put(
          `https://gestionlocationvoiture.onrender.com/api/v1/Reservation/${this.clickMember._id}`,
          {
