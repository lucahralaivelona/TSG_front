      ...
      <div class="row">
        <main :class="$style.table">
          <section :class="$style.table__header">
            <h2 style="">Liste des départements</h2>
            ...
            <table :class="$style['mainTable']">
              <thead :class="$style['tableauThead']">
                <tr :class="$style['tableauTrHeader']">
                  ...
                  <th data-role="sort-header">Marque</th>
                  <th data-role="sort-header">Type</th>
                  <th data-role="sort-header">Prix journalière</th>

                  <th data-role="sort-header">Nombre de place</th>
                  <th data-role="sort-header">Consommation</th>
                  <th data-role="sort-header">Couleur</th>
                  <th data-role="sort-header">Boite de vitesse</th>
              ...
              <tbody :class="$style['tableauTbody']">
                ...
                >
                  ...
                  <td>{{ member.type }}</td>
                  <td>{{ member.prix }}</td>
                  <td>{{ member.nombreDePlace }}</td>
                  <td>{{ member.consommation }} L/100</td>
                  <td>{{ member.couleur }}</td>
                  <td>{{ member.boiteDeVitesse }}</td>
                  <td>{{ member.status }}</td>
          ...
          <section>
            ...
            >
              <div class="container">
                <div class="title">Ajout de département</div>
                  ...
                  <div class="user-details">
                    ...
                    <div class="input-box">
                      ...
                      <input
                        ...
                        required
                        v-model="carDetails.type"
                      />
                    </div>
                    <div class="input-box">
                      <span class="details">À propos</span>
                      <input
                        type="text"
                        placeholder="À propos de la département"
                        required
                        v-model="carDetails.about"
                      />
                    </div>
                    <div class="input-box">
                      ...
                      <input
                        ...
                        required
                        v-model="carDetails.prix"
                      />
                    </div>
                    <div class="input-box">
                      <span class="details">Nombre de Places</span>
                      <input
                        type="number"
                        placeholder="Nombre de places"
                        required
                        v-model="carDetails.nombreDePlace"
                      />
                    </div>
                    <div class="input-box">
                      <span class="details">Consommation</span>
                      <input
                        type="text"
                        placeholder="Consommation"
                        required
                        v-model="carDetails.consommation"
                      />
                    </div>
                    <div class="input-box">
                      ...
                      <input
                        ...
                        placeholder="Couleur"
                        required
                        v-model="carDetails.couleur"
                      />
                    </div>
                    <div class="input-box">
                      <span class="details">Boîte de Vitesse</span>
                      <input
                        type="text"
                        placeholder="Boîte de vitesse"
                        required
                        v-model="carDetails.boiteDeVitesse"
                      />
                    </div>
                    <div class="input-box">
                    ...
                    <div class="input-box">
                      ...
                      <input
                        ...
                        placeholder="Note"
                        required
                        v-model="carDetails.note"
                      />
                    </div>
                    <div class="input-box">
                      <span class="details">Image Principale</span>
                      <input
                        type="file"
                        @change="handleFileChange($event, 'img')"
                        required
                      />
                    </div>
                    <div class="input-box">
                      <span class="details">Image Complémentaire</span>
                      <input
                        type="file"
                        @change="handleFileChange($event, 'imgC')"
                        required
                      />
                    </div>
                    <div class="input-box">
                    ...
                    <div class="input-box">
                      ...
                      <input
                        type="file"
                        @change="handleFileChange($event, 'img3')"
                        required
                      />
                    </div>
                  </div>
            ...
            >
              <div class="container">
                <div class="title">Modification de département</div>
                <form action="#">
                  <div class="user-details">
                    <div class="input-box">
                    ...
                    <div class="input-box">
                      ...
                      <input
                        ...
                        placeholder="Nombre de places"
                        required
                        v-model="clickMember.nombreDePlace"
                      />
                    </div>
                    <div class="input-box">
                      <span class="details">Consommation</span>
                      <input
                        ...
                        placeholder="Consommation"
                        required
                        v-model="clickMember.consommation"
                      />
                    </div>
                    <div class="input-box">
                      <span class="details">Couleur</span>
                    ...
                    <div class="input-box">
                      ...
                      <input
                        ...
                        placeholder="Boîte de vitesse"
                        required
                        v-model="clickMember.boiteDeVitesse"
                      />
                    </div>
                    <div class="input-box">
                      <span class="details">Status</span>
                    ...
                    <div class="input-box">
                      ...
                      <input
                        ...
                        placeholder="Note"
                        required
                        v-model="clickMember.note"
                      />
                    </div>
                    <!-- <div class="input-box">
                      <span class="details">Image Principale</span>
                      <input type="file" @change="handleFileChange($event, 'img')" required />
                    </div>
                    <div class="input-box">
                      <span class="details">Image Complémentaire</span>
                      <input type="file" @change="handleFileChange($event, 'imgC')" required />
                    </div>
                    <div class="input-box">
                      <span class="details">Image 1</span>
                      <input type="file" @change="handleFileChange($event, 'img1')" required />
                    </div>
                    <div class="input-box">
                      <span class="details">Image 2</span>
                      <input type="file" @change="handleFileChange($event, 'img2')" required />
                    </div>
                    <div class="input-box">
                      <span class="details">Image 3</span>
                      <input type="file" @change="handleFileChange($event, 'img3')" required />
                    </div> -->
                  </div>
            ...
            >
              <div class="container">
                <div class="title">Suprresion de département</div>
                <form action="#">
                  <div class="user-details">
                    <div class="input-box">
                      <h4>Voulez-vous supprimer {{ clickMember.model }} ?</h4>
                    </div>
                  </div>
...
export default {
  ...
  methods: {
    ...
    showSuccessAlert() {
      Swal.fire({
        icon: "success",
        title: "département repertoriée dans la base",
    ...
    showEditAlert() {
      Swal.fire({
        icon: "success",
        title: "Modification d'information de département avec succès !",
    ...
    getAllMembers() {
      axios
        .get("https://gestionlocationvoiture.onrender.com/api/v1/Car")
        .then((response) => {
    ...
    saveMember() {
      axios
        .post(
          "https://gestionlocationvoiture.onrender.com/api/v1/Car",
          {
            model: this.newMember.model,
            marque: this.newMember.marque,
            type: this.newMember.type,
            prix: this.newMember.prix,
            nombreDePlace: this.newMember.nombreDePlace,
            consommation: this.newMember.consommation,
            couleur: this.newMember.couleur,
            boiteDeVitesse: this.newMember.boiteDeVitesse,
            status: "disponible",
          },
          {
            headers: {
    ...
    EditMember() {
      axios
        .put(
          `https://gestionlocationvoiture.onrender.com/api/v1/Car/${this.clickMember._id}`,
          {
