      ...
      <div class="row">
        <main :class="$style.table">
          <section :class="$style.table__header">
            <h2 style="">Liste des utilisateurs</h2>
            ...
            <table :class="$style['mainTable']">
              <thead :class="$style['tableauThead']">
                <tr :class="$style['tableauTrHeader']">
                  ...
                  <th data-role="sort-header">Tel</th>

                  <th data-role="sort-header">E-Mail</th>
                  <th></th>
                  <th></th>
                </tr>
              </thead>
          ...
          <section>
            ...
            >
              <div class="container">
                <div class="title">
                  Modification de l'information de l'utilisateur
                </div>
                <form action="#">
                  <div class="user-details">
                    <div class="input-box">
            ...
            >
              <div class="container">
                <div class="title">Suprresion d'un utilisateur</div>
                <form action="#">
                  <div class="user-details">
                    <div class="input-box">
                      <h4>Voulez-vous supprimer {{ clickMember.nom }} ?</h4>
                    </div>
                  </div>
...
export default {
  ...
  methods: {
    ...
    handleFileChange(event, key) {
      this.utilisateur[key] = event.target.files[0];
    },
    ...
    handleSubmit() {
      ...
      for (let key in this.utilisateur) {
        formData.append(key, this.utilisateur[key]);
      }
    ...
    showSuccessAlert() {
      Swal.fire({
        icon: "success",
        title: "Voiture repertoriée dans la base",
    ...
    showEditAlert() {
      Swal.fire({
        icon: "success",
        title: "Modification d'information de voiture avec succès !",
    ...
    getAllMembers() {
      axios
        .get("https://gestionlocationvoiture.onrender.com/api/v1/Users/")
        .then((response) => {
    ...
    EditMember() {
      axios
        .put(
          `https://gestionlocationvoiture.onrender.com/api/v1/Users/${this.clickMember._id}`,
          {
            nom: this.clickMember.nom,
            adresse: this.clickMember.adresse,
            tel: this.clickMember.tel,
            mail: this.clickMember.mail,
            password: this.clickMember.password,
          },
          {
            headers: {
              "Content-Type": "application/json",
